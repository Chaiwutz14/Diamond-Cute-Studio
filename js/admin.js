    ...
    <div class="admin-box">
      ...
      <div class="form-row" style="margin-bottom:1rem">
        ...
        <div class="form-group" style="margin:0"><label class="form-label">ประเภทส่วนลด</label>
          <select class="form-input form-select" id="coupon-type">
        ...
        ${rows.map(c => {
          ...
          return `<tr>
            ...
            <td style="white-space:nowrap;text-align:right">
              <button class="btn btn-ghost btn-sm" onclick="editCoupon('${DMC.escapeHtml(c.id)}')" style="border-radius:var(--r-md)" title="แก้ไข">✏️</button>
              <button class="btn btn-ghost btn-sm" onclick="deleteCoupon('${DMC.escapeHtml(c.id)}')" style="border-radius:var(--r-md);color:var(--rose)" title="ลบ">🗑️</button>
            </td></tr>`;
        }).join('')}
        </tbody></table>
      </div>`;
